...
<html lang="en">
    ...
    <body class="bg-[#171C22] min-h-screen ">
        ...
        <div class="flex flex-wrap gap-4 px-10 mt-6">
            ...
            <div class="w-full sm:w-[48%] md:w-[30%] lg:w-[23%] p-4 bg-white border-gray-200 rounded-lg shadow-sm dark:bg-[#333]  break-words whitespace-normal">
                ...
                <a href="/edit_note/{{ $note->id }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-green-900 rounded-lg hover:bg-green-700 place-items-end">
                ...
                <form action="/delete_note/{{$note->id}}" method="POST">
                    @csrf
                    @method('DELETE')
                <button class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-red-900 rounded-lg hover:bg-red-700 mt-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
